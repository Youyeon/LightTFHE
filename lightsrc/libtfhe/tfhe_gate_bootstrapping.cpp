...
static LweParams *default_80bit_gate_bootstrapping_parameters() {
...
static LweParams *default_128bit_gate_bootstrapping_parameters() {
...
EXPORT LweSample *new_gate_bootstrapping_ciphertext_(const LweParams *params) {
...
EXPORT LweSample *
new_gate_bootstrapping_ciphertext_array(int32_t nbelems, const LweParams *params) {
    return new_LweSample_array(nbelems, params);
}
